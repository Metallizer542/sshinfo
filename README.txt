...
4) запуск скрипта осуществляется коммандой:
   ...
   python.exe /Users/daniilkutyrev/PycharmProjects/sshinfo/CmdStartProgram.py /Users/daniilkutyrev/Desktop/servers.txt user password /Users/daniilkutyrev/Desktop/test.html

   где:

    python.exe - путь до интерпритатора python
    ...
    intertrust_user - юзернейм пользователя под которым выполняется вход на сервер
    bscW2)8Ch2 - пароль пользователя
